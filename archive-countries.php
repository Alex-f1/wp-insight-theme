  ...
  <div class="all-countries">
    <div class="all-countries__top container">
      <div class="all-countries__image">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/countries-bg2.png" alt loading="lazy"
             width="1920" height="1863" sizes="100vw" srcset="
    ...
    <div class="countries-list-wrapper swiper-parent">
      ...
      <div class="countries-list-wrap per__footer container">
  ...
  <div class="hotels-and-villas swiper-parent">
    <div class="hotels-and-villas__header container">
      <h2 class="hotels-and-villas__title h2 text-splitter">
        ...
        elseif ($current_lang === 'ru'):
          echo 'Популярные отели';

        endif;
        ?>

      </h2>
      <div class="hotels-and-villas__text text-splitter">
        <?php
        $current_lang = pll_current_language();

        if ($current_lang === 'en'):
          echo 'Interesting countries in 2023';

        elseif ($current_lang === 'ru'):
          echo 'Интересные страны в 2023 году';
        ...
        <div class="hotels-and-villas__items-wrapper js-hotels-and-villas-slider swiper">
          <div class="hotels-and-villas__items swiper-wrapper">
            <?php
              ...
              foreach ($hotels_services as $post) {
                setup_postdata($post);

                ?>
                  <div class="hotels-and-villas__item swiper-slide">
                    <a href="<?php the_permalink(); ?>" class="hotels-and-villas__item-in">
                      <?php if ( !empty (get_the_post_thumbnail_url()) ) : ?>
                      <span class="hotels-and-villas__item-image">
                        <span class="hotels-and-villas__item-shield">exclusive offers</span>
                        <img loading="lazy" width="479" height="317" sizes="100vw" src="<?php the_post_thumbnail_url(); ?>" alt="">
                      </span>
                      <?php endif; ?>
                      <span class="hotels-and-villas__item-container">
                        <span class="hotels-and-villas__item-stars"><span></span></span>
                        <span class="hotels-and-villas__item-title"><?php the_title(); ?></span>
                        <!--<span class="hotels-and-villas__item-address">
                          <span class="svg-icon svg-icon--location-icon" aria-hidden="true">
                            <svg class="svg-icon__link">
                        ...
                        <span class="hotels-and-villas__item-text"><?php the_excerpt(); ?></span>
